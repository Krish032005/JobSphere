...
const CenterContent = () => {
  return (
<div className='w-full h-110 mt-15'>
    <div className='flex flex-col items-center gap-10 py-6'>
        {/* head text */}
        <div className='text-center'>
        <h1 className='font-bold text-4xl mb-2'>Find your next role, or your next hire</h1>
        <p className='font-semibold text-xl text-(--color-primary-hover)'>Jobsphere connects candidates and recruiter in one place</p>
        </div>
        ...
        <button className='font-semibold text-lg bg-(--color-surface) border border-(--color-border) rounded-lg px-8 py-2
        ...
        <div className='flex gap-15'>
            <div className='text-center font-semibold text-lg bg-(--color-surface-secondary) rounded-lg px-10 py-4'>
